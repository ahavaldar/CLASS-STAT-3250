...
x = list04[-5:]         # subsetting the last 5 elements of the list
print(12*-5*-9*-7*4)    # calculating product
q1 = -15120
...
list05 = list01 + list04         # concatenating the list
list05.sort()                    # sorting from low to high 
...
q4 = biglist[3::5]      # "3" is starting with the 4th element, "5" gets every
                        # 5th element    
